  ...
  return (
    <main className='flex flex-col min-h-screen max-w-[1440px] mx-auto items-center'>
      <div className='relative sm:px-20 flex flex-col items-center'>
          <Image className='object-cover relative rounded-2xl h-96 mt-80 z-10 md:h-auto md:mt-0 md:z-0' src='/billsFarm.png' alt='billsFarm' width={1280} height={500} priority={true} />
        ...
        <div className='flex flex-col justify-center items-center pl-8 pr-6 mt-4 gap-x-16 md:items-start md:pr-0 md:flex-row'>
          <div>
            <CustomTitle
              ...
              color='blue1000'
            />
            <p className='text-lg mt-6 mb-8'>From supply chain disruptions and skills shortages fuelled by the COVID19 pandemic to
              skyrocketing
        ...
        <div className='w-full hidden md:flex flex-col items-center'>
          ...
          />
          <HorizontalBarChart />
          <p className='mt-6 max-w-[800px] ml-20'>Zeller data shows that the three most concerning areas for small business owners today are the
            increasing cost of supplies, reduced consumer spending, and continuing challenges in finding and retaining
            staff. Before we explore how to mitigate the effects of these for small businesses, it’s important to understand
