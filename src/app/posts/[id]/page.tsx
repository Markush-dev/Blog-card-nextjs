  ...
  return (
    <>
      ...
      <div className='md:px-20'>
        <Breadcrumb items={[...breadcrumbItemsPostPage, { label: `${data.title}`, url: '/' }]} />
        ...
        <div className='max-w-[842px] pt-12 sm:mr-8 px-8 xl:px-0 flex flex-col sm:gap-y-16 gap-y-8 overflow-hidden'>
          <div className='flex flex-col text-lg gap-4'>
            ...
            <p>You’d be forgiven for thinking profit is the most important yardstick for commercial triumph. After all,
              positive financial performance is a good indicator that something is going right. However, it’s not the
              only
          ...
          <div className='flex flex-col gap-6'>
            ...
            <p>While the net worth of your business is important, success means different things to different business
              owners. And, although the bottom line will be critical when there’s investors involved, it’s not the
              be-all
            ...
            <div>When determining the success of your business, other important questions to ask yourself include:
              ...
              <p>While success takes different forms for different businesses, there tends to be a common thread that
                ties
          ...
          <div className='hidden sm:inline'>
            <Image
              ...
              priority={true}
            />
            <p className='text-sm text-[#6D7274] max-w-md mt-6'>Purus morbi egestas odio egestas ac id leo egestas
              purus,
          ...
          <div>
            ...
            <div className='flex flex-col gap-3 pt-5'>
              ...
              <p>You need to decide what is most important to you: the growth of your venture, the money it provides
                you,
              ...
              <p>As desirable as all three sound — growth, liquidity and control — most successful businesses face a
                ...
                how much cash you want to generate — whereas comparing debt earnings can show you whether you are at
                risk
          ...
          <div>
            ...
            <div className='flex flex-col gap-4 mt-5'>
              <p>Whatever you sell, you need to keep abreast of changing consumer needs and behaviours in the
                marketplace.
              ...
              <p> Take the growing trend of conscious consumerism, for example. Customers now expect you to incorporate
                sustainable practices, procurement methods and processes into your business. In fact, studies show 9 in
                10
          ...
          <div>
            ...
            <div className='flex flex-col gap-4 mt-5'>
              ...
              <p>Managing your business in a way that ensures you have enough cash on hand to pay the bills, pay
                yourself
                and
          ...
          <div>
            ...
            <p className='mt-4'>Brainstorm new ways to keep them interested in your brand and in your products. After
              all,
          ...
          <div className='border-x-2 border-[#0071CE]'>
            <p className='px-4'>THIS IS A BLOCK QUOTE Nec turpis consequat nec pellentesque varius mattis. Dis urna
              ornare
              lacus, augue
              ridiculus. Commodo vestibulum congue diam, neque ultricies. Egestas felis blandit nulla commodo pharetra
              ut.
              Phasellus pellentesque nulla leo sit leo sagittis tristique mauris. Pretium tortor mattis diam platea
              justo.
              Eu sed eu, pretium mauris facilisis nisi, semper ultricies. Sed quis vitae ut tincidunt viverra. Elementum
              mi
              morbi enim tincidunt pharetra maecenas a mauris. Id nibh dolor sit consectetur non sit quam nunc. Magna
              sit
